...
local aa = {
    function()
        ...
        function x.CreateWindow(C, D)
            ...
            local E = e(s.Window) {
                ...
                Title = D.Title,
                SubTitle = D.SubTitle,
                MiscTitle = D.MiscTitle,
                MiscSubTitle = D.MiscSubTitle,
                ToggleGUI = D.ToggleGUI or {},
                TabWidth = D.TabWidth
            }
            x.Window = E
            x:SetTheme(D.Theme)
        ...
        function x.Destroy(C)
            if x.Window then
                ...
                x.GUI:Destroy()
                if getgenv then
                    getgenv().excuted_CMOONHUB = nil
                end
                for uy, fl in next, x.Unloadedfunction do
                    task.spawn(fl)
                end
            end
        end
        function x.UnloadedCallback(C, D)
            D = D or function()

            end
            table.insert(x.Unloadedfunction, type(D) == "function" and D or function()
            end)
        end
        ...
        function x.ToggleTransparency(C, D)
            x.Transparency = D
            if x.Window then
                x.Window.AcrylicPaint.Frame.Background.BackgroundTransparency = (tonumber(D) >= tonumber(0.95) and tonumber(0.95)) or tonumber(D)
            end
                ...
                if #x.NotifyHolder:GetChildren() > 1 then
                    for _ , XL in next, x.NotifyHolder:GetChildren() do
                        if XL:IsA("Frame") then
                            XL.Frame.Holder.Background.BackgroundTransparency = (tonumber(D) >= tonumber(0.95) and tonumber(0.95)) or tonumber(D)
                        end
                    end
                end
            end
            ...
            l.Frame =
                ...
                },
                {
                    ...
                    j(
                        "Frame",
                        {
                            BackgroundTransparency = (tonumber(e(d.Parent.Parent).Transparency) >= tonumber(0.95) and tonumber(0.95)) or tonumber(e(d.Parent.Parent).Transparency),
                            Size = UDim2.fromScale(1, 1),
                            Name = "Background",
    ...
    [16] = function()
        ...
        return function(n)
            ...
            local o, p, q, zq =
                ...
                function(q, r)
                    local s = {Callback = r or function()
                    end, Dragging = nil, DragA = nil, DragB = nil, DragC = nil, Options = n.ToggleGUI.Options}
                    s.UICorner = s.Options and {
                        [1] = l("UICorner", {CornerRadius = n.ToggleGUI.UICorner or UDim.new(s.Options == "Circle" and 1 or 0, s.Options == "Circle" and 1 or 0)})
                    } or {}
                    if not n.ToggleGUI.Image or not string.find(n.ToggleGUI.Image, "rbxassetid://") then
                        s.Frame =
                        l(
                        "ImageButton",
                        {
                            Size = n.ToggleGUI.Size or UDim2.new(0.065, 0, 0.120, 0),
                            AnchorPoint = n.ToggleGUI.AnchorPoint or Vector2.new(0.5, 0.5),
                            ZIndex = 125,
                            ImageTransparency = n.ToggleGUI.ImageTransparency or 0,
                            BackgroundTransparency = n.ToggleGUI.BackgroundTransparency or 1,
                            BackgroundColor3 = n.ToggleGUI.BackgroundColor3 or Color3.fromRGB(255, 255, 255),
                            Parent = q,
                            Position = n.ToggleGUI.Position or UDim2.new(0.033, 0, 0.938, 0),
                        ...
                        if n.ToggleGUI.AutoBackgroundColor then
                            s.Frame =
                            l(
                            "ImageButton",
                            {
                                ...
                                Parent = q,
                                Position = n.ToggleGUI.Position or UDim2.new(0.033, 0, 0.938, 0),
                                Image = n.ToggleGUI.Image,
                                ThemeTag = {BackgroundColor3 = "BackgroundColor"}
                            },
                            s.UICorner
                            )
                        else
                    ...
                    xo.ToggleGUI.GUI = s.Frame
                    for iuy, jdx in next, n.ToggleGUI do
                        xo.ToggleGUI[iuy] = jdx
                    end
                    return s
                end
            o.SubTitle =
            ...
            function()
                p.Window:Dialog {
                    Title = n.MiscTitle or "NN/NN/NNNN",
                    Content = n.MiscSubTitle or "● Content",
                    Buttons = {{Title = "Close"}}
                }
            end
            )
    ...
    [17] = function()
        ...
        return function(t)
            ...
            v.TitleBar = e(d.Parent.TitleBar) {
                Title = t.Title,
                SubTitle = t.SubTitle,
                MiscTitle = t.MiscTitle,
                MiscSubTitle = t.MiscSubTitle,
                ToggleGUI = t.ToggleGUI or {},
                Parent = v.Root,
                Window = v
            }
            local BS =
            ...
            m.AddSignal(
                ...
                function(M)
                    if v[M] then
                        v[M] = M == "Position" and v.Root.Position or v.Root.Size
                    elseif M == "Visible" and u.ToggleGUI.TransparencyWhileToggle then
                        u.ToggleGUI.GUI.ImageTransparency = v.Root.Visible and 0 or 0.75
                    end
                end
            )
            m.AddSignal(
            ...
            function v.Minimize(M, TT)
                ...
                if u.ToggleGUI.TransparencyWhileToggle and not v.Root.Visible then
                    u.ToggleGUI.GUI.ImageTransparency = 0.75
                end
                if not C then
                    C = true
            ...
            function v.Dialog(N, O)
                ...
                s(
                    "UISizeConstraint",
                    {MinSize = Vector2.new(400, 165), MaxSize = Vector2.new(800, math.huge), Parent = P.Root}
                )
    ...
    [48] = function()
        ...
        return {
            ...
            AcrylicNoise = 0.92,
            BackgroundColor = Color3.fromRGB(52, 44, 84),
    ...
    [49] = function()
        ...
        return {
            ...
            AcrylicNoise = 0.92,
            BackgroundColor = Color3.fromRGB(44, 76, 76),
    ...
    [51] = function()
        ...
        return {
            ...
            AcrylicNoise = 0.94,
            BackgroundColor = Color3.fromRGB(32, 28, 28),
    ...
    [53] = function()
        ...
        return {
            ...
            AcrylicNoise = 0.92,
            BackgroundColor = Color3.fromRGB(124, 52, 84),
